...
export default function UsersModelUpdateForm(props) {
  const {
    id: idProp,
    usersModel: usersModelModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = usersModelRecord
      ...
      : initialValues;
    setCognito_id(cleanValues.cognito_id);
    ...
    setImage_key(cleanValues.image_key);
    setErrors({});
  };
  const [usersModelRecord, setUsersModelRecord] =
    React.useState(usersModelModelProp);
  React.useEffect(() => {
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || usersModelModelProp)}
